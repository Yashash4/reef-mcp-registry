...
Requires Go 1.22+. This fork lives inside the Reef monorepo, pinned against upstream commit
`e49a402864104c19c9a560ad73e06d5493e5d876` from `github.com/veeainc/lobstertrap`.

```bash
git clone https://github.com/Yashash4/reef-mcp-registry.git
cd reef-mcp-registry/lobstertrap-reef
make build
```
